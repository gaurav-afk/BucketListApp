...
public class ThingsToDoActivityAdapter extends RecyclerView.Adapter<ThingsToDoActivityAdapter.PlaceViewHolder> {

    private String[] places;
    public ThingsToDoActivityAdapter(String[] places){
        this.places = places;
    }
